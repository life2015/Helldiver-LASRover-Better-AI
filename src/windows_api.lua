-- Adapted for local prototype from CowboyBingus/SentryAimRetention.
return function()
    ...
    local api = {}
    function api.pid() return tonumber(kernel.GetCurrentProcessId()) end
    ...
    function api.writable_data(address, size)
        ...
        local region = ffi.new('RoverSpreadMemoryRegion[1]')
